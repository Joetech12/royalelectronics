...
const ProductDetail1 = ({ img, img2, name, desc, slug, cat }) => {
  return (
    <div className="bg-white outline outline-[2px] outline-black/10 overflow-hidden shadow-lg hover:shadow-xl py-[30px] px-[20px] flex flex-col w-[250px] h-[360px] justify-center items-center group relative m-[5px] ">
      {/* Image */}
      <div className=" cursor-pointer px-[10px] transition-all duration-500 group-hover:scale-105 absolute top-[10%] group-hover:opacity-[0%]">
        <img src={img} alt="" objectfit="contain" height="250" width="250" />
      </div>
      <div className=" cursor-pointer px-[10px] transition-all duration-500 group-hover:scale-105 absolute top-[10%] z-[5] opacity-[0%] group-hover:opacity-[100%]">
        <img src={img2} alt="" objectfit="contain" height="250" width="250" />
      </div>
      {/* Title */}
      ...
      <div className="absolute text-[14px] bottom-[22px] px-[20px] py-[12px] w-full justify-center bg-white flex items-center translate-y-[100px] group-hover:translate-y-[0px] transition-all duration-500">
        <Link href={`/product/${slug}`}>
          <button className="outline xs:outline-[1px] md:outline-[2px] font-semibold text-royal rounded-[50px] px-[10px] py-[7px] mr-[10px] cursor-pointer">
            Details
          </button>
        </Link>
